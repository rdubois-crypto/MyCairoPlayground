...
func bench_full_windowed{range_check_ptr, ec_op_ptr: EcOpBuiltin* } (){
 alloc_locals;
 %{ print("\n******************* Bench windowed sharmir's trick mulmuladd :") %}
...
func main{range_check_ptr, ec_op_ptr: EcOpBuiltin* }() {
    ...
    bench_full_windowed{range_check_ptr=range_check_ptr, ec_op_ptr=ec_op_ptr}();
