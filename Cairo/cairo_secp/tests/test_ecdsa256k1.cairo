...
func test_verify_ecdsa{range_check_ptr}() {
  ...
  let pub:EcPoint= recover_public_key(msg_hash=msg_hash, r=r.x, s=s.x, v=parity);

  let res1=pub.x.d0;
  let res2=pub_opti.x.d0;
  
  
  %{  print("\n x1 =", ids.res1, "x2=",ids.res2) %}  
...
func main{ range_check_ptr}() {
    ...
    let (__fp__, _) = get_fp_and_pc();
     ...
     %{ print("\n ECDSA test optimized implementation over sec256r1") %}//result of signature
